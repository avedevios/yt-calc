...
private extension ViewController {
    ...
    func setupLine1() {
        ...
        let precentButton = createButton(order: 2, title: "%", tag: 17)
        precentButton.addTarget(self, action: #selector(buttonPressed(_:)), for: .touchUpInside)
        precentButton.backgroundColor = AppColors.topButtons
        precentButton.setTitleColor(.black, for: .normal)
        ...
        line1.addSubview(precentButton)
